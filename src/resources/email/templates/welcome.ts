                        ...
                        <td class="column column-1"
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-1"
                            ...
                            <tr>
                              <td class="pad">
                                <h1
                                  style="margin: 0; color: #272727; direction: ltr; font-family: 'Ubuntu', Tahoma, Verdana, Segoe, sans-serif; font-size: 32px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;">
                                  <span class="tinyMce-placeholder" style="text-transform: capitalize;">Welcome ${firstName}</span></h1>
                              </td>
                            </tr>
                          </table>
                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  ...
                                  <p style="margin: 0;">We're excited to have you as a part of our community and looking
                                    forward to helping you share ideas and create art. Here are a few things you can do
                                    with your account:</p>
                                </div>
                              </td>
                            </tr>
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-3"
                            ...
                            <tr>
                              <td class="pad">
                                <h1
                                  style="margin: 0; color: #272727; direction: ltr; font-family: 'Ubuntu', Tahoma, Verdana, Segoe, sans-serif; font-size: 25px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;">
                                  Blog posts</h1>
                              </td>
                            </tr>
                          </table>
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-4"
                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#101112;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                  <p style="margin: 0;">You can share ideas and information with other users as a blog
                                    post. These posts can be edited at any time.</p>
                                </div>
                              </td>
                            </tr>
                          </table>
                          <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-5"
                            ...
                            <tr>
                              <td class="pad">
                                <h1
                                  style="margin: 0; color: #272727; direction: ltr; font-family: 'Ubuntu', Tahoma, Verdana, Segoe, sans-serif; font-size: 25px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;">
                                  <span class="tinyMce-placeholder">Security</span></h1>
                              </td>
                            </tr>
                          </table>
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-6"
                            role="presentation"
                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#101112;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                  <p style="margin: 0;">To ensure your account are is extra safe we recommend that you
                                    verify your email address, with a verified account you have access to the following
                                    security features:</p>
                                </div>
                              </td>
                            </tr>
                          </table>
                          <!--[if mso]><style>#list-r1c0m6 ul{margin: 0 !important; padding: 0 !important;} #list-r1c0m6 ul li{mso-special-format: bullet;}#list-r1c0m6 .levelOne li {margin-top: 0 !important;} #list-r1c0m6 .levelOne {margin-left: -20px !important;}</style><![endif]-->
                          <table border="0" cellpadding="10" cellspacing="0" class="list_block block-7" id="list-r1c0m6"
                            role="presentation"
                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                            <tr>
                              <td class="pad">
                                <div class="levelOne" style="margin-left: 0;">
                                  <ul class="leftList" start="1"
                                    ...
                                    <li style="margin-bottom: 0; text-align: left;">Two-factor authentication</li>
                                    <li style="margin-bottom: 0; text-align: left;">Account recovery codes</li>
                                    <li style="margin-bottom: 0; text-align: left;">Reset compromised passwords</li>
                                    <li style="margin-bottom: 0; text-align: left;">Update email address</li>
                                  </ul>
                                </div>
                              </td>
                            </tr>
                          </table>
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-8"
                            role="presentation"
                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#101112;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                  <p style="margin: 0; margin-bottom: 16px;">Finally, we will let you know when new
                                    features are released.</p>
                                  <p style="margin: 0; margin-bottom: 16px;">Have a great day!</p>
                                  <p style="margin: 0;">Samuel Umoh</p>
                                </div>
                              </td>
                            </tr>
                          </table>
                          <table border="0" cellpadding="0" cellspacing="0" class="html_block block-9"
                            role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                            <tr>
                              <td class="pad">
                                <div align="center"
                                  ...
                                  <div class="our-class">
                                    <div style="margin-top: 20px;border-top:1px solid #787878;margin-bottom: 20px;">
                                    </div>
                                  </div>
                                </div>
                              </td>
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-10"
                            role="presentation"
                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#101112;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:13px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:15.6px;">
                                  <p style="margin: 0; margin-bottom: 16px;">This is an automatically generated email,
                                    please do not reply</p>
                                  <p style="margin: 0;">You received this email because you signed up for a SnowSenpai
                                    account.</p>
                                </div>
                              </td>
                            </tr>
                          </table>
                          <table border="0" cellpadding="10" cellspacing="0" class="social_block block-11"
                            role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                            <tr>
                              <td class="pad">
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" class="social-table"
                                    ...
                                    <tr>
                                      ...
                                      <td style="padding:0 2px 0 2px;"><a href="https://www.linkedin.com/"
                                          target="_blank"><img alt="Linkedin" height="32" src="https://res.cloudinary.com/dwmwo3mpo/image/upload/v1693898434/node-ts-api/public-assets/linkedin2x_wm46re.png"
