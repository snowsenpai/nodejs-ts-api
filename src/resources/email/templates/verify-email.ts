                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  ...
                                  <p style="margin: 0;">You can click the button below to verify this email address</p>
                                </div>
                              </td>
                            </tr>
                          </table>
                                  ...
                                  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${url}" style="height:42px;width:126px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#3b4ecf"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:16px"><![endif]--><a
                                    ...
                                    target="_blank"><span
                                      style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                        ...
                                        email</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                </div>
                              </td>
                            </tr>
                          </table>
